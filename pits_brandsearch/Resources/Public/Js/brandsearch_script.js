...
function showDetails( uid, pageId, sysLangUid ){
	...
	$.ajax({
		type: "POST",
		url: "?id="+pageId+"&tx_pitsbrandsearch_pitsbrandsearch[action]=show&tx_pitsbrandsearch_pitsbrandsearch[controller]=Brandsearch&tx_pitsbrandsearch_pitsbrandsearch[brand_uid]="+uid+"&L="+sysLangUid,
...
$(document).ready(function(){
	...
	$(".adetail").bind("click",function(){
		...
		$.ajax({
			type: "POST",
			url: "?id="+pageId+"&tx_pitsbrandsearch_pitsbrandsearch[action]=search&tx_pitsbrandsearch_pitsbrandsearch[controller]=Brandsearch&L="+langUid,
	...
	$("#brands_backtoList").live("click",function(){
		$('#loader').show();
		$('.alphadetails').css("opacity",".3");
		var string = "";
		var keyValue = "";
