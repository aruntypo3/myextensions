...
/**
 * Test case for class Tx_Vst_tour_Controller_VsttourController.
 *
 * @version $Id$
 ...
 */
class Tx_Vst_tour_Controller_VsttourControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
